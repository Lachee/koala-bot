...
namespace KoalaBot.CommandNext
{
    ...
    public class Query : Dictionary<string, string>
    {
        ...
        public Query(IEnumerable<KeyValuePair<string, string>> collection) : base(collection) { }
        ...
        /// <summary>
        /// Gets the boolean, returning null if it doesnt not exist.
        /// </summary>
        /// <param name="key"></param>
        /// <param name="default"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets the int, returning null if it doesnt not exist.
        /// </summary>
        /// <param name="key"></param>
        /// <param name="default"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets the double, returning null if it doesnt not exist.
        /// </summary>
        /// <param name="key"></param>
        /// <param name="default"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets the long, returning null if it doesnt not exist.
        /// </summary>
        /// <param name="key"></param>
        /// <param name="default"></param>
        /// <returns></returns>
